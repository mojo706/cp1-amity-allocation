...
class TestAmity(unittest.TestCase):
    ...
    def test_input_is_string(self):
        ...
        self.assertEqual(
            self.amity_test.create_room(2, "Tsavo"),
            "Invalid Input",
            msg="Invalid Input")
    ...
    def test_adding_fellow(self):
        ...
        initial_fellow_count = len(self.amity_test.fellows)
        self.amity_test.add_person("Chuchu Omar", "")
        new_fellow_count = len()

    def test_adding_staff(self):
        """ Is the staff added successfully"""
        initial_staff_count = len(self.amity_test.all_staff)

        new_staff_count = len(self.amity_test.all_staff)
        self.assertEqual(
